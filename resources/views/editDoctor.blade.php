...
@section('pagetitle','Edit Doctors')
...
<div class="col-12 col-xl-6">
    <div class="card">
        <div class="card-body p-4">
            ...
            <form method="post" action="{{ route('updateDoctor',$doctor->id) }}"  enctype="multipart/form-data" class="row g-3">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                    <label for="input1" class="form-label">Doctor Name</label>
                    <input name="name" type="text"  value="{{ $doctor->name }}" class="form-control" id="input1" placeholder="First Name">
                    @error('name')
                ...
                <div class="col-md-12">
                    ...
                    <input name="email" type="email" value="{{ $doctor->email }}" readonly class="form-control" id="input4">
                    @error('email')
                    <div class="alert alert-border-danger alert-dismissible fade show">
                      <div class="d-flex align-items-center">
                        <div class="font-35 text-danger"><span class="material-icons-outlined fs-2">report_gmailerrorred</span>
                ...
                <div class="col-md-12">
                    ...
                    <input name="phone" type="text" value="{{ $doctor->phone }}" class="form-control" id="input3" placeholder="Phone">
                    @error('phone')
                    <div class="alert alert-border-danger alert-dismissible fade show">
                      <div class="d-flex align-items-center">
                        <div class="font-35 text-danger"><span class="material-icons-outlined fs-2">report_gmailerrorred</span>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="specialization" class="form-control" id="input11" placeholder="specialization ..." rows="3">{{ $doctor->specialization }}</textarea>
